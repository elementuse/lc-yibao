import { ChatMessageDtoReadState, ChatMessageDtoSide, CreatePaymentDtoEditionPaymentType, CreatePaymentDtoPaymentPeriodType, CreatePaymentDtoSubscriptionPaymentGatewayType, DefaultTimezoneScope, FriendDtoState, IncomeStatisticsDateInterval, IsTenantAvailableOutputState, RegisterTenantInputSubscriptionStartType, SalesSummaryDatePeriod, UserNotificationState, ImportInputOfChannelObjectInputFieldsWriteMode, QueryChannelObjectInputState } from '@shared/service-proxies/service-proxies';
...
export class ChannelObjectFieldsWriteMode {
    static Override: number = ImportInputOfChannelObjectInputFieldsWriteMode._0;
    static ReWrite: number = ImportInputOfChannelObjectInputFieldsWriteMode._1;
}

export class ChannelObjectStateState {
    static NotInUse: number = QueryChannelObjectInputState._0;
    static InUse: number = QueryChannelObjectInputState._1;
    static Obsolete: number = QueryChannelObjectInputState._2;
    static WaitingForSync: number = QueryChannelObjectInputState._3;
    static Error: number = QueryChannelObjectInputState._4;
    static WaitingForUpdate: number = QueryChannelObjectInputState._5;
    static WaitingForApproval: number = QueryChannelObjectInputState._6;
    static WaitingForDelete: number = QueryChannelObjectInputState._7;
    static NotApproved: number = QueryChannelObjectInputState._8;
    static Deleted: number = QueryChannelObjectInputState._9;
}
