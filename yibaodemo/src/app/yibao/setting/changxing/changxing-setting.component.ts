...
@Component({
    templateUrl: "./changxing-setting.component.html",
    animations: [appModuleAnimation()]
})
export class ChangxingSettingComponent extends AppComponentBase
    implements OnInit {
    hospitalCode: string = "";
    ...
    ngOnInit() {
        ...
        this.key = `Changxing.HospitalCode.${this.suffix}`;
