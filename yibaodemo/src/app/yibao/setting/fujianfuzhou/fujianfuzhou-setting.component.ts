...
@Component({
    templateUrl: './fujianfuzhou-setting.component.html',
    animations: [appModuleAnimation()]
})

export class FujianfuzhouSettingComponent extends AppComponentBase implements OnInit {
    hospitalCode: string = '';
    ...
    ngOnInit(): void {
        ...
        this.key = `Longyan.HospitalCode.${this.suffix}`;
