...
@Component({
    templateUrl: "./refund-fujianfuzhou.component.html"
})
export class RefundFujianfuzhouComponent extends AppComponentBase
    implements OnInit {
    ...
    constructor(
        ...
        private fujianfuzhouyibaoservice: ClientFujianfuzhouProxy,
    ...
    public refund(): any {
        ...
        this.fujianfuzhouyibaoservice
            .fujianfuzhourefund(refundParams)
            .mergeMap(res => {
