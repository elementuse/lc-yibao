...
import { ClientLongyanProxy } from "./client-longyan.proxy";

@Component({
    templateUrl: './process-longyan.component.html'
})
export class ProcessLongyanComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        ...
        private longyanprocessservice: ClientLongyanProxy,
    ...
    public readCard(): any {
        ...
        this.longyanprocessservice.longyanReadCard().subscribe(res => {
    ...
    public register(): any {
        ...
        this.longyanprocessservice.longyanregister(registerParams).mergeMap(res => {
    ...
    public preSettle(): any {
        ...
        this.longyanprocessservice.longyanpresettlementreadcard(cno).subscribe(res =>
        {
            if (res.xming0 == null || res.xming0 == '') {
                ...
                this.longyanprocessservice.longyanpresettlement(settlementParams)
                    .subscribe(res => {
    ...
    settle(): any {
        ...
        this.longyanprocessservice.longyanpresettlementreadcard(cno).subscribe(res =>
        {
            if (res.xming0 == null || res.xming0 == '') {
                ...
                this.longyanprocessservice.longyansettlement(settlementParams, this.hisData.diagnose.id, this.hisData.diagnose.name).mergeMap(res => {
                    this.settleResult = res;
