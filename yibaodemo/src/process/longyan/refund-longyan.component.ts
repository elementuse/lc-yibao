...
@Component({
    templateUrl: "./refund-longyan.component.html"
})
export class RefundLongyanComponent extends AppComponentBase
    implements OnInit {
    ...
    constructor(
        ...
        private longyanyibaoservice: ClientLongyanProxy,
    ...
    public refund(): any {
        ...
        let refundParams = 
            {
                cardno: this.patient.cardno, //卡号
                cxdjh0: this.settleResult.djlsh0 //原单据号
            };
        this.longyanyibaoservice
            .longyanrefund(refundParams)
            .mergeMap(res => {
