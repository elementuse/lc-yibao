...
@Component({
    templateUrl: "./refund-test.component.html"
})
export class RefundTestComponent extends AppComponentBase
    implements OnInit {
    ...
    public refund(): any {
        ...
        var res = this.processService.action(this.processid, request).subscribe(res => {
            this.doAction(res);
