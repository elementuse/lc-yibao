...
import { ChargeItemServiceModule } from '@shared/chargeitem-service.module';
import { ChargeItemServiceFactory } from '@shared/chargeItem.factory';
import { AbpHttpConfiguration,AbpHttpInterceptor } from '@shared/abpHttpInterceptor';
        ...
        return new Promise<boolean>((resolve, reject) => {
            ...
            AppPreBootstrap.run(appBaseUrl, () => {
                ...
                localForage.config({
                    ...
                    description: 'Cached data for Insurance'
                });
